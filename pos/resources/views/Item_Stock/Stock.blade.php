...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        ...
        <div class="col-8">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- <input type="text" class="form-control" id="itemno" aria-describedby="emailHelp" name="itemno"> --}}
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Unit_of_measure</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Stock In</label>
            ...
            <button class="additemuom">Add Item UOM</button>
            <button class="editgroup">Edit</button>
    ...
    <table id="item_uom" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        <thead class="thead-primary">
            <tr>
                ...
                <th scope="col">unit_of_measure_code</th>
                <th scope="col">identifier_code</th>
