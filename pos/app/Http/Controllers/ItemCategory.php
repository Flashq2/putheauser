...
class Itemcategory extends Controller
{
    ...
    public function index()
    {
        ...
        return view("itema.category",compact('getpermissioncode','get'));
    ...
    // {
    //     if ($request->ajax()) {
    //         $data = Modelcategory::latest()->get();
    //         return DataTables::eloquent(Modelcategory::query())
    //             ->addIndexColumn()
    ...
    public function store(Request $request)
    {
        ...
        $validator=Validator::make($request->all(),[
            'code'=> 'required|unique:item_categorys',
        ]
